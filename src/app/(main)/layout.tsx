        ...
        >
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t border-[#00f0ff]/20 px-4 py-4 flex flex-col gap-4">
              <Link href="/" className="text-gray-300 hover:text-[#00f0ff] transition-colors">
                Events
              </Link>
              <Link href="/my-tickets" className="text-gray-300 hover:text-[#00f0ff] transition-colors">
                My Tickets
              </Link>
              <Link href="/marketplace" className="text-gray-300 hover:text-[#00f0ff] transition-colors">
                Marketplace
              </Link>
              <Link href="/scan" className="text-gray-300 hover:text-[#00f0ff] transition-colors">
                Scan
              </Link>
            </div>
          )}
